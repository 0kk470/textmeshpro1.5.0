...
namespace TMPro
{
    ...
    public abstract class TMP_Text : MaskableGraphic
    {
        ...
        public static event Func<int, string, Material> OnMaterialAssetRequest;
                ...
                switch (m_xmlAttribute[0].nameHashCode)
                {
                    ...
                    case 28511: // <FONT>
                        ...
                        else if (materialAttributeHashCode == 103415287 || materialAttributeHashCode == 72669687) // using material attribute
                        {
                            ...
                            {
                                // Load new material
                                var materialName = new string(m_htmlTag, m_xmlAttribute[1].valueStartIndex, m_xmlAttribute[1].valueLength);
                                tempMaterial = OnMaterialAssetRequest?.Invoke(materialHashCode, materialName);

                                if(tempMaterial == null)
                                    tempMaterial = Resources.Load<Material>(TMP_Settings.defaultFontAssetPath + materialName);
